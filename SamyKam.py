...
PCB design and advisory by Andres Sabas with a team work with @electronicats (https://twitter.com/electronicats)
...
- change many parameters without ssh
- change wifi configuration [ssid/pass] *
- any shell command using Bluetooth
